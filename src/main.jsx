...
function App() {
  ...
  return <div className={`app${playing?' is-playing':''}${reducedEffects?' reduced-effects':''}`}>
    ...
    {modal?.type==='background'&&<Modal title={t("选择你的背景")} onClose={()=>setModal(null)}><BackgroundPicker backgroundId={backgroundId} animateBackground={animateBackground} onSelect={setBackgroundId} onAnimateChange={setAnimateBackground} locale={locale}/></Modal>}
